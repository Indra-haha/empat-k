...
const TagihanGenerator = ({
    ...
    console.log("Data untuk tagihan:", item);
    ...
    const handleSaveToDatabase = async () => {
        ...
        try {
            ...
            const imageFile = new File([blob], `${noInvoice}.png`, {
                type: "image/png",
            });
            ...
            >
                ...
                <div className="flex justify-between items-start border-b-4 border-blue-600 pb-8">
                    <div className="flex gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500 mt-1 uppercase font-semibold">
                                ...
                                <br />
                                Jl. Mangkuyudan 57 Yogyakarta 55143
                                <br />
                                Telp. (0274) 378733
                            </p>
                        </div>
                    ...
                    <div className="text-right">
                        <h2 className="text-4xl font-black text-slate-200 italic mb-2">
                            TAGIHAN
                        </h2>
                    ...
                    <div className="text-right flex flex-col justify-end text-red-500 italic">
                        <p className="text-sm font-mono font-bold">
                            ...
                            <span className="text-2xl underline decoration-double font-black">
                                INV-
                                {formatToShortDate(new Date().toISOString())}-
                                {item.no}
                            </span>
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-12 border-2 border-blue-600 rounded-xl overflow-hidden min-h-[300px]">
                    ...
                    <div className="col-span-4 p-6 bg-blue-600 text-white text-right">
                        <p className="text-[10px] font-black text-blue-200 uppercase mb-4">
                            Total Item
                        </p>
                ...
                <div className="mt-10 grid grid-cols-12 gap-8">
                    <div className="col-span-7 flex justify-around items-end">
                        <div className="text-center">
                            ...
                            <p className="border-t border-slate-300 px-4 text-[10px] font-bold">
                                Hormat Kami
                            </p>
                        </div>
                        <div className="text-center">
                    ...
                    <div className="col-span-5 bg-slate-50 p-6 rounded-xl space-y-2">
                        ...
                        <div className="flex flex-col border-y-2 border-dotted border-red-200 py-2">
                            ...
                            <span className="text-2xl font-black text-red-600">
                                {formatPrice(item.total_price * 0.3)}
                            </span>
                        </div>
                ...
                <div className="mt-10 text-[9px] text-center text-slate-400 italic border-t pt-4">
                    <p className="font-bold">
                        Transfer BCA 445.055.0936 a/n Heru Budi Setiawan
                    </p>
                    <p>
                        Dokumen ini adalah bukti penagihan sah dari Sistem
                        Digital CV. Empat-K
                    </p>
                </div>
            </div>
            ...
            <div className="flex gap-4 mb-6 mt-8">
                {item.url_img_tagihan === null ? (
                    ...
                    item.url_img_bukti && (
                        <div>
                            {openBukti === false ? (
                                <button onClick={() => setOpenBukti(true)} className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-full font-bold shadow-lg transition-all">
                                    Lihat Bukti Tagihan
                                </button>
                            ) : (
                                <>
                                    <span className="text-normal text-md mt-4 mb-2">
                                        Bukti Pembayaran
                                    </span>
                                    <img
